   ...
   public void perform() {
      ...
      if (file.startsWith("c")) {
         ...
         if (!file.startsWith("a")) {
            ...
            this.msg("<b>Invalid file specified. <i>Valid files: all, conf, board, factions, players", new Object[0]);
            return;
         }
      ...
      this.msg("<i>Reloaded <h>%s <i>from disk, took <h>%dms<i>.", new Object[]{fileName, timeReload});
   }
}
